...
public class ScannerActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent.putExtra(MonitorActivity.EXTRAS_DEVICE_NAME, device.getName());
        intent.putExtra(MonitorActivity.EXTRAS_DEVICE_ADDRESS, device.getAddress());
        if (mScanning) {
        ...
        public void onLeScan(final BluetoothDevice device, int rssi, byte[] scanRecord) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    try
                    {
                        condition=deviceName.equals("Blue ECG");
                    }
